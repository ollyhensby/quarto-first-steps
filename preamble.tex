...
\lofoot{\stackanchor{\stackanchor{\raggedleft{\color{gray}$${{< var project_name >}}$$}}{\raggedleft{$${{< var document_description >}}$$}}}{\raggedleft{\currentname}}}
\cofoot{}
% CENTRE TEXT IN IMAGE
% REF: https://stackoverflow.com/a/62283887
\rofoot{    
    \begin{tikzpicture}
        \node at (0,0) {\includegraphics[width=1.75cm]{../../images/mf-footer-logo.png}};
        \node at (current bounding box.center) {\thepage\ / \pageref*{LastPage}};
    \end{tikzpicture}
    }

% TITLEPAGE
% SET MAXFORDHAM BACKGROUND
\usepackage{wallpaper}
\ThisCenterWallPaper{}{../../images/mf-background.png}
\setlength{\wpXoffset}{1.0cm} % Offset mf_background.png
\ThisURCornerWallPaper{0.5}{../../images/mf-title.png}
% ^ Can't offset ThisURCornerWallPaper for some reason so have just cheated
% and added white padding to the image itself
\ThisLLCornerWallPaper{}{../../images/mf-doc-issue.png}
...
\begin{tabular}{l} % Create table and left-align
    ...
    \Huge{\textbf{$${{< var project_name >}}$$}}\\[10pt]
    \huge{$${{< var document_description >}}$$}\\[10pt]
    \Large{$${{< var issue_history.status_description >}}$$}\\
    \large{$${{< var issue_history.date >}}$$}\\
    \large{$${{< var document_name >}}$$}\\
\end{tabular}
\vspace*{\fill}
\egroup
}
